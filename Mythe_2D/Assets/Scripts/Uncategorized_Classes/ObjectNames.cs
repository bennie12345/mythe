...
public class ObjectNames : MonoBehaviour {
    ...
    public static readonly string birdStoneEnemyName = "StoneBird";
    public static readonly string fishStoneEnemyName = "StoneFish";
    public static readonly string birdSlicedEnemyName = "BirdSliced";
